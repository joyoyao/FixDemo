...
Java_com_example_dongnao_fixdemo_HandlerNative_init(JNIEnv *env, jclass type, jint api) {
...
JNIEXPORT void JNICALL
Java_com_example_dongnao_fixdemo_HandlerNative_replaceMethod(JNIEnv *env, jclass type,
